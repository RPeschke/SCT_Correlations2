...
#ifdef WIN32
#define  _typeName ___typeName___()
#define _dataDescription ___dataDescription__()
#endif // WIN32
...
#else
  std::string& ___typeName___();
  std::string& ___dataDescription__();

  const std::string& ___typeName___() const;
  const std::string& ___dataDescription__() const;
  static std::string ___typeName;
  static std::string ___dataDescription;
