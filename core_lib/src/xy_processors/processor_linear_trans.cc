...
void processor_linear_trans::processHit(double x, double y)
{
 ...
 xy_plane linear_trans(const xy_plane& pl, double a11, double a12, double a21, double a22, processor_prob pprob /*= saveWithRandomName("linear_trans__")*/)
{
 ...
 xy_plane rotate(const xy_plane& pl, double angle, processor_prob pprob /*= saveWithRandomName("rotate__")*/)
{
