...
xy_plane transform(const xy_plane& pl, double x_slope, double x_offset, double y_slope, double y_offset, processor_prob& pprob /*= saveWithRandomName("transform__")*/)
{
 ...
 xy_plane transform_move(const xy_plane& pl, double x_offset, double y_offset, processor_prob& pprob /*= saveWithRandomName("transform__")*/)
{
